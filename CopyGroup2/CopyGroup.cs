    ...
    public class CopyGroup : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                Reference reference = uiDoc.Selection.PickObject(ObjectType.Element, groupPickFilter, "Выберете элемент");
                ...
                Room roomRez = GetRoomByPoint(doc, point);
                XYZ roomRezCenter = GetElementCenter(roomRez);
                XYZ pointRez = roomRezCenter + offset;
